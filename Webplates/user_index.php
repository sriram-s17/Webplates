...
<body class="bg-light font">
	...
	<div class="px-4 pt-5 my-5 text-center border-bottom">
		...
		<h3 class="display-4 fw-bold">Welcome <?php echo $_SESSION["wpusrname"]; ?>!!</h3>
    ...
    <div class="container my-5">
		<div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
			<div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
				<h1 class="display-4 fw-bold lh-1">Add your template</h1>
				<li class="lead">first ready your preview image of your template</li>
				<li class="lead">Zip your file and note that your file and image file both should have less than 8 mb</li>
				<li class="lead">then provide these details in add template page</li>
				<li class="lead">After clicking upload button, you will need to select the homepage from the unzipped folder we show because it is used to preview your template for others clients</li>
				<a class="btn btn-primary btn-lg px-4 mt-5" href="upload_template.php">Add your template</a>
			</div>
